...
\item El \emph{OperationsManager} a su vez, se encarga de construir una operación. Para eso, debe recurrir al \emph{DatabaseManager} para obtener la información de la operación. Luego, con dicha información obtiene las instancias del extractor e inspector correspondientes a dicha operación solicitándoselas al \emph{RepositoriesManager}.
