...
El sistema cuenta con un único punto de entrada y salida de datos a través del componente que denominamos \emph{Coordinator}. De esta forma, el mismo ofrece todos los comandos con los que cuenta el usuario.

Para llevar a cabo los diversos comandos, el \emph{Coordinator} se comunica con, o bien el \emph{Operations Manager}, para ejecutar operaciones o consultar información sobre las mismas; o bien el \emph{Extensions Manager}, para modificar las extensiones con las que cuenta el sistema.
