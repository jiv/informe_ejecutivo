...
\section{Ejemplo de una ejecución}
Comenzamos cargando los datos del dispositivo HTC obtenido utilizando el comando \texttt{./load\_data\_sets.py}
\newline
...
Iniciamos la herramienta ejecutando el comando \texttt{./andi.py}
\newline
...
Establecemos la información del dispositivo con el comando \texttt{set\_device\_info}.
\newline
...
Utilizamos el comando \texttt{list} para listar las operaciones soportadas por el dispositivo.
\newline
...
Utilizamos el comando \texttt{execute} para ejecutar primero la operación que extrae SMS.
\newline
...
Utiizamos el comando \texttt{execute} para ejecutar las operaciones que extraen datos de contactos de Facebook y WhatsApp.
\newline
...
A continuación se puede ver la estructura de los datos resultantes de ejecutar las operaciones recién descritas.
\newline
...
Como se puede ver en la imagen, cada operación almacena los datos en una carpeta independiente.

Finalmente, utilizando la herramienta cybox-to-html podemos ver los datos inspeccionados de una forma más clara. En la siguiente imagen se muestra el objeto File que representa a la base de datos fb.db de la cual se extrajeron los contactos:
\newline

\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/FbDBFileObject}
        \caption{Objeto File que representa a la base de datos fb.db}
    \end{center}
\end{figure}

A continuación se pueden ver algunos de objetos Contact que representan a los contactos encontrados:
\newline

\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/FBContactObjects}
        \caption{Objetos Contact que representan los contactos encontrados}
    \end{center}
\end{figure}