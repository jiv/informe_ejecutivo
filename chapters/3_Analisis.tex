...
Como forma de resumir la interacción entre el usuario y el sistema, en la figura \ref{diagramaCasosDeUso} se muestran los casos de uso en base a dos roles:

\begin{itemize}
\item El primero de ellos trata del rol \emph{usuario}, en el cual se puede utilizar el sistema tanto en modo interactivo como en modo batch.
...
El prototipo de la herramienta deberá estar enfocado en la extracción de datos de aplicaciones. Para esto, contaremos con un tipo de fuente de datos llamado \emph{Application} que permitirá tomar como fuente de datos aquellos datos pertenecientes a una aplicación instalada en el dispositivo.
...
\item Al estar rooteado el emulador, contamos con acceso a todos los datos del mismo.
\end{itemize}
