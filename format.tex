...
\usepackage{titlesec}
\titlespacing{\section}{0pt}{2.5ex plus 1ex minus .2ex}{0pt plus 0pt}
\titlespacing{\subsection}{0pt}{2.5ex plus 1ex minus .2ex}{0pt plus 0pt}
\titlespacing{\subsubsection}{0pt}{2.5ex plus 1ex minus .2ex}{0pt plus 0pt}
...
\newenvironment{narrowenumerate}
{ \begin{enumerate} \setlist[enumerate]{topsep=0pt, parsep=0pt, partopsep=0pt} }
{ \end{enumerate} } 
...
% Estilos de los cabezales y pies de página
